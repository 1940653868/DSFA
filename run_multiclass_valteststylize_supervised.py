...
if __name__ == "__main__":
    ...
    # python run_multiclass_valteststylize_supervised.py --runs 1 --lmda_consistency 50  --encdata_mode dwt --devices 4 

    
    # 考虑跑一组带均值方差的TUEV，style，无预训练
    # python run_multiclass_valteststylize_supervised.py --runs 3 --lmda_consistency 50  --encdata_mode dwt --devices 4 --get_five_run 1 
    
    # 
    # python run_multiclass_valteststylize_supervised.py --runs 3 --lmda_consistency 50  --encdata_mode dwt --devices 4 --epochs 1
